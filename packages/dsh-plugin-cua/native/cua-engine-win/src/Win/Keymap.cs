...
internal static class Keymap
{
    ...
    private static Dictionary<string, KeyDefinition> Build()
    {
        ...
        Add(new KeyDefinition(VK_LEFT, Extended: true), "left", "arrowleft", "arrow_left");
        Add(new KeyDefinition(VK_RIGHT, Extended: true), "right", "arrowright", "arrow_right");
        Add(new KeyDefinition(VK_UP, Extended: true), "up", "arrowup", "arrow_up");
        Add(new KeyDefinition(VK_DOWN, Extended: true), "down", "arrowdown", "arrow_down");
        Add(new KeyDefinition(VK_HOME, Extended: true), "home");
        Add(new KeyDefinition(VK_END, Extended: true), "end");
        Add(new KeyDefinition(VK_PRIOR, Extended: true), "pageup", "page_up", "prior");
        Add(new KeyDefinition(VK_NEXT, Extended: true), "pagedown", "page_down", "next");
